...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <nav className="fixed top-0 w-full bg-slate-900/90 backdrop-blur-md z-50 border-b border-slate-700/50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="text-xl font-semibold text-teal-400 hover:text-teal-300 transition-colors">
              EM
            </Link>
            <div className="hidden md:flex items-center gap-8">
              <a href="#about" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.about}</a>
              <a href="#experience" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.experience}</a>
              <a href="#projects" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.projects}</a>
              <a href="#publications" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.publications}</a>
              <a href="#education" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.education}</a>
              <a href="#contact" className="text-slate-300 hover:text-white transition-colors">{t[language].nav.contact}</a>
              <button
                onClick={() => setLanguage(language === 'en' ? 'es' : 'en')}
                className="px-4 py-2 bg-teal-500/10 border border-teal-500/30 rounded-full text-teal-400 hover:bg-teal-500/20 transition-colors text-sm font-medium"
              >
                {language === 'es' ? '🇲🇽 ES' : '🇺🇸 EN'}
              </button>
            </div>
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-6 bg-slate-900 border-t-4 border-blue-500/30">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {t[language].about.cards.map((card, idx) => (
              <div key={idx} className="bg-slate-900/60 backdrop-blur-sm p-6 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:transform hover:scale-105 hover:shadow-xl hover:shadow-teal-500/10">
          ...
          <div className="mt-12 bg-slate-900/50 p-8 rounded-2xl border border-slate-700/50">
            <h3 className="text-2xl font-semibold text-white mb-4">{t[language].about.languages}</h3>
            <div className="flex flex-wrap gap-4">
              <div className="px-6 py-3 bg-teal-500/10 border border-teal-500/30 rounded-full">
                <span className="text-teal-400 font-medium">🇲🇽 {language === 'en' ? 'Spanish: Native' : 'Español: Nativo'}</span>
              </div>
              <div className="px-6 py-3 bg-teal-500/10 border border-teal-500/30 rounded-full">
                <span className="text-teal-400 font-medium">🇺🇸 {language === 'en' ? 'English: Advanced' : 'Inglés: Avanzado'}</span>
              </div>
              <div className="px-6 py-3 bg-teal-500/10 border border-teal-500/30 rounded-full">
                <span className="text-teal-400 font-medium">🇧🇷 {language === 'en' ? 'Portuguese: Basic' : 'Portugués: Básico'}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Experience Section */}
      <section id="experience" className="py-20 px-6 bg-slate-950 border-t-4 border-slate-700">
        <div className="max-w-7xl mx-auto relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-12 text-center">
          ...
          <div className="space-y-8">
            {/* Surfing Digital */}
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Co-founder & CEO</h3>
                  <p className="text-teal-400 text-lg font-semibold">Surfing Digital</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">{language === 'en' ? 'Aug 2015 – Present' : 'Ago 2015 – Presente'}</span>
              </div>
            ...
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">CEO, MVS Exponencial</h3>
                  <p className="text-teal-400 text-lg font-semibold">MVS Capital Mexico</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">{language === 'en' ? 'Sep 2022 – Mar 2025' : 'Sep 2022 – Mar 2025'}</span>
              </div>
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start">
                  <span className="text-teal-400 mr-2">•</span>
            ...
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Director of Marketing and Media</h3>
                  <p className="text-teal-400 text-lg font-semibold">OpenExO Global</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">Feb 2019 – Dec 2019</span>
              </div>
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start">
                  <span className="text-teal-400 mr-2">•</span>
            ...
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Director of Exponential Growth</h3>
                  <p className="text-teal-400 text-lg font-semibold">Growth Institute Global</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">May 2018 – Jan 2019</span>
              </div>
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start">
                  <span className="text-teal-400 mr-2">•</span>
            ...
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  ...
                  <p className="text-teal-400 text-lg font-semibold">Garage Video LATAM</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">{language === 'en' ? 'Aug 2012 – Aug 2015' : 'Ago 2012 – Ago 2015'}</span>
              </div>
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start">
                  <span className="text-teal-400 mr-2">•</span>
            ...
            <div className="bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all hover:shadow-xl hover:shadow-teal-500/20">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">{language === 'en' ? 'Key Account Manager' : 'Gerente de Cuentas Clave'}</h3>
                  <p className="text-teal-400 text-lg font-semibold">Flexi Shoes Mexico</p>
                </div>
                <span className="text-slate-400 mt-2 md:mt-0">{language === 'en' ? 'Jun 2010 – Jul 2012' : 'Jun 2010 – Jul 2012'}</span>
              </div>
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start">
                  <span className="text-teal-400 mr-2">•</span>
